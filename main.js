...
function closingCode(){
    ...
    if (localStorage.getItem('startTimesSave') === null) {
        ...
        startTimes = JSON.parse(localStorage.getItem('startTimesSave'))
    }
    startTimes = startTimesUpdate    
    
    localStorage.setItem('startTimesSave', JSON.stringify(startTimes))   
    ...
    if (localStorage.getItem('endTimesSave') === null) {
        ...
        endTimes = JSON.parse(localStorage.getItem('endTimesSave'))
    }
